# Generated by Django 3.2.8 on 2023-09-18 18:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='format: required, max-255', max_length=255, unique=True, verbose_name='product name')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='format: Y-m-d H:M:S', verbose_name='date product last updated')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_text', models.CharField(help_text='format:required, max_255', max_length=255, verbose_name='alternative text')),
